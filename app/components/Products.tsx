...
const Products = () => {
  ...
  return (
    <div className=" mx-auto flex justify-center flex-col items-center  md:w-4/5 sm:w-full    bg-[#FCFCFC] p-24">
      <div className=" border-t-2 border-[#D4AF37] w-20 p-1 font-medium"></div>
      <h2 className="text-[#2E2E2E]">FEATURED</h2>
      <div className="md:flex md:flex-row gap-2 sm:flex sm:flex-col">
        {data.map((card: any, index: number) => {
          return (
            <div
              key={index}
              className="mt-20 border-solid border-2 border-[#F0F0F0] flex flex-col items-center justify-center md:p-16 gap-5 relative shadow-xl sm:px-24 py-20 "
            >
