...
const Hero = () => {
  ...
  return (
    <div
      className={`text-white backgroundd md:bg-right bg-main bg-contain bg-no-repeat bg-center w-full flex flex-col items-center md:justify-center justify-evenly md:gap-12 mt-5 h-[488px] md:h-[600px]`}
    >
