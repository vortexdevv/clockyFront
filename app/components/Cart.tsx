      ...
      <div className="w-full md:w-2/3 p-4">
        <div className="grid gap-4 grid-cols-[repeat(auto-fit,minmax(250px,1fr))] place-items-center">
          {cartItems.map((item) => (
            <div
              key={item._id}
              className="bg-white shadow-lg w-60 max-h-full flex flex-col justify-around rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl"
            >
