...
const Arrivals = () => {
  ...
  return (
    <div className=" mx-auto flex justify-center flex-col items-center md:w-4/5 w-full bg-[#FCFCFC] p-16">
      ...
      <div className="md:flex md:flex-nowrap gap-4 flex flex-wrap">
        {data.map((card: any, index: number) => {
          return (
            <div
              key={index}
              className="group m-auto md:mt-20 md:p-8 lg:p-16 mt-7 border-solid border-2 border-[#F0F0F0] flex flex-col items-center justify-center p-14 gap-4 relative shadow-2xl"
            >
